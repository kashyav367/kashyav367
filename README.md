...
<i>I build the interface where a click turns into something useful —<br/>
React on top, Node/Express underneath, JWT-secured, MongoDB-backed, shipped end to end.</i>
...
I'm a **full-stack developer with a shipping mindset**. I like living at the seam where a rough idea becomes a working product someone can click through — React and JavaScript at the core, Node/Express and REST underneath, MongoDB for the data, and enough end-to-end ownership to take a feature from idea to deploy.
...
|---|---|---|---|
| **FormVerse** ⭐ | No-code form builder — create, share, and collect responses to custom forms with automated secure handling of submissions and access. | React, Node.js, JavaScript | [GitHub](#) · [Live](#) |
...
| **trello-project** | Trello-style task/project board with a Node.js backend for managing boards, lists, and cards. | JavaScript, Node.js | [GitHub](https://github.com/kashyav367/trello-project) |
...
**Certifications** — ChaiCode Full Stack Web Development Cohort · Jan 2026 – Jun 2026
